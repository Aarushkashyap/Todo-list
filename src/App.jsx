    ...
    <>
      ...
      <div className="container mx-auto my-5 rounded-xl p-5 bg-purple-200 min-h-[80vh]">
        <div className="addTodo my-5">
          ...
          <button
            onClick={handleAdd}
            className="bg-purple-700 hover:bg-purple-900 p-2 py-1 text-sm font-bold text-white rounded-md mx-6"
          >
            Save
          </button>
        </div>
            ...
            <input name={item.id} onChange={handleCheckBox} type="checkbox" value={item.isCompleted} id="" />
                ...
                <div className="buttons flex h-full">
                  <button
                    ...
                    className="bg-purple-700 hover:bg-purple-900 p-2 py-1 text-sm font-bold text-white rounded-md mx-1"
                  >
                    Edit
                  </button>
                  <button
